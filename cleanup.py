...
class BlenderCleanup:
    ...
    def copy_folder(self):
        ...
        try:
            ...
            print(f"{Fore.GREEN}Folder {Fore.YELLOW}'{self.source_folder}'{Fore.GREEN} has been copied to {Fore.YELLOW}'{destination_path}'{Style.RESET_ALL}.")
    ...
    def delete_blend_files_in_temp(self):
        try:
            blend_files = [file for file in os.listdir(self.temp_folder) if file.endswith(".blend")]
